...
export async function generateOutputs(sessionId, faqs, needsReview) {
  ...
  // 2. Rewrite items that need a generated response (normal + rto + escalation + internal-review).
...
function writeReviewXlsx(sessionDir, needsReview) {
  ...
  const ws = XLSX.utils.json_to_sheet(rows, {
    header: [
      ...
      'Tags', 'Keywords', 'Source Column', 'Original Source Text', 'Generated Response',
    ],
  });
